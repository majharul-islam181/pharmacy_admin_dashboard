...
//                           //   children: [
//                           //     Text(
//                           //       '\${report.totalEarning.toStringAsFixed(2)}',
...
//                           //     Text(
//                           //       '${report.growthPercentage.toStringAsFixed(0)}%',
//                           //       style: TextStyle(
//                           //         fontSize: 12,
...
//                       // Legend
//                       ...report.chartData.map((data) => _buildLegendItem(data)),
//                     ],
//                   ),
//                 ),
//               ],
...
//     return report.chartData.map((data) {
...
//   Widget _buildLegendItem(ChartDataModel data) {
//     return Padding(
